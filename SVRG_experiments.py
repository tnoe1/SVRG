...
def SVRG_testbed(X_train, y_train, X_test, y_test):
    ...
    label_text_format = {'color': 'b', 'fontsize': 16}
    title_text_format = {'color': 'b', 'fontsize': 20}
    ...
    plt.xlabel('Update Frequency, m', label_text_format)
    plt.ylabel('$\\tilde{\mu}$ Calculations', label_text_format)
    plt.title('Health Insurance: Number of $\\tilde{\mu}$ Calculations Until Convergence', title_text_format)
